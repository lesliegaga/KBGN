...
def parse_args():
    ...
    parser.add_argument('--ue_lambda', type=float, default=0.1)
    parser.add_argument('--alpha', type=float, default=0.)
    parser.add_argument('--entirate', type=int, default=100)
    parser.add_argument('--sprate', type=int, default=1)
    parser.add_argument('--idf_sampling', type=int, default=1)
